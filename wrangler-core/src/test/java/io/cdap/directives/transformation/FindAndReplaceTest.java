 ...
 */
 ...
 public class FindAndReplaceTest {
   ...
   public void testMultipleColumns() throws Exception {
     ...
     Assert.assertEquals("this is a exam", rows.get(1).getValue("body"));
     Assert.assertEquals("exam title", rows.get(1).getValue("title"));
     Assert.assertEquals("another exam here", rows.get(2).getValue("body"));
     Assert.assertEquals("title with exam", rows.get(2).getValue("title"));
   }
 }
